...
public class Testss {
    public static void main(String[] args) {
        ...
        //Stream<Double> randoms = Stream.generate(Math::com.mycoding.javabase.random).limit(100);
        ...
        //List<String> com.mycoding.javabase.list = new ArrayList<>();
        //com.mycoding.javabase.list.add("hello");
        //com.mycoding.javabase.list.add("world");
        //com.mycoding.javabase.list.stream().flatMap(Testss::characterStream).forEach(System.out::print);
