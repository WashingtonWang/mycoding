...
public class MapComputeTest {
  ...
  public static void main(String[] args) {
    //Map<String, List<String>> com.mycoding.javabase.map = computeIfAbsentTest();
  ...
  public static Map<String, List<String>> computeIfPresentTest() {
    ...
    //for (int i = 0; i < 15; i++) {
    //  com.mycoding.javabase.map.computeIfPresent(String.valueOf(i), k -> new LinkedList<>()).add("456");
    //}
