...
public class StreamRunTest {
    public static void main(String[] args) {
        ...
        //wordList.add("b");
        //wordList.add("c");
        //List<String> output = wordList.stream().com.mycoding.javabase.map(String::toUpperCase).collect(Collectors.toList());
        //output.stream().forEach(System.out::println);
        //List<Integer> nums = Arrays.asList(1,2,3,4,5);
        //List<Integer> squareNums = nums.stream().com.mycoding.javabase.map(n -> n*n).collect(Collectors.toList());
        ...
        //        .com.mycoding.javabase.map(String :: toUpperCase)
        ...
        //        .com.mycoding.javabase.map(Person::getName).limit(10).skip(3).collect(Collectors.toList());
        ...
        try {
            ...
            List<String> words = br.lines()
                    ...
                    .com.mycoding.javabase.map(String::toLowerCase)
                    .distinct()
                    .sorted()
