 ...
 */
public class ThreadPoolUtils_new {
  private static Logger log = LoggerFactory.getLogger(ThreadPoolUtils_new.class);

  private ThreadPoolUtils_new() {
  }
  ...
  public static void submit(Runnable task) {
    ThreadPoolUtils_new.getInstance().submit(task);
  }

  public static Object executeAndGet() {
    return ThreadPoolUtils_new.getInstance().executeAndGet();
  }

  public static void shutdown() {
    ThreadPoolUtils_new.getInstance().shutdown();
  }

  public static boolean isShutdown(){
    return ThreadPoolUtils_new.getInstance().isShutdown();
  }
