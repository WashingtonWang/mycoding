...
public class AnnoTest {
    ...
    public static void main(String[] args) throws ClassNotFoundException{
        Class c = Class.forName("com.mycoding.javabase.atinterface.eg1.Anno");
        ...
        if (flag){
            ...
            System.out.println("First com.mycoding.javabase.annotation: "+ firstAnnotation.value());
        }
        ...
        for (Method m : list){
            ...
            System.out.println("second com.mycoding.javabase.annotation's\nname:\t" + secondAnnotation.name()
